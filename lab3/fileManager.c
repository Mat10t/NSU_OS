...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(progName, "createDir") == 0) createDirectory(argv[1]);
    else if (strcmp(progName, "listDir") == 0) listDirectory(argv[1]);
    else if (strcmp(progName, "removeDir") == 0) removeDirectory(argv[1]);
    else if (strcmp(progName, "createFile") == 0) createFile(argv[1]);
    else if (strcmp(progName, "readFile") == 0) readFile(argv[1]);
    else if (strcmp(progName, "removeFile") == 0) removeFile(argv[1]);
    else if (strcmp(progName, "createSymlink") == 0 && argc == 3) createSymlink(argv[1], argv[2]);
    else if (strcmp(progName, "readSymlink") == 0) readSymlink(argv[1]);
    else if (strcmp(progName, "removeSymlink") == 0) removeSymlink(argv[1]);
    else if (strcmp(progName, "createHardlink") == 0 && argc == 3) createHardlink(argv[1], argv[2]);
    else if (strcmp(progName, "removeHardlink") == 0) removeHardlink(argv[1]);
    else if (strcmp(progName, "fileInfo") == 0) getFileInfo(argv[1]);
    else if (strcmp(progName, "changePermissions") == 0 && argc == 3) changePermissions(argv[1], strtol(argv[2], NULL, 8));
    else {
